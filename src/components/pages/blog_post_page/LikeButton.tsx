...
export default function LikeButton({
  ...
  return (
    <button
      ...
      title={disabled ? "You cannot applaud your own story" : undefined}
      disabled={disabled}
      onClick={async () => {
    ...
    >
      <div className="relative flex gap-[5px] items-center group-disabled:pointer-events-none group/wrapper">
        {showPopup && (
          <div
            className="grid place-items-center text-[15px] absolute -left-1 bottom-10 bg-lighterblack text-white h-[35px] w-[35px] rounded-full animate-scale"
            key={+new Date()}
          >
            +{currentUserLikeCount}
          </div>
        ...
        <svg
          ...
          viewBox="0 0 24 24"
          aria-label="clap"
          className="fill-grey group-disabled:opacity-40 group/wrapper-hover:fill-black"
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
